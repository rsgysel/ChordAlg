...
Graph::Graph( Graph& super_graph, VertexVector X ) :
...
VertexNames* Graph::InducedNames( Graph& super_graph, VertexVector X )
{
...
AdjacencyLists* Graph::InducedVertices( Graph& super_graph, VertexVector X )
{
    std::sort( X.begin(), X.end() );
